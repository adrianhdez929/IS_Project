        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeographicPosition = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientServices", x => new { x.IdClient, x.IdService });
                    table.ForeignKey(
                        name: "FK_ClientServices_Clients_IdClient",
                        column: x => x.IdClient,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientServices_Services_IdService",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_IdAirportDestination",
                table: "Flights",
                column: "IdAirportDestination");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_IdAirportOrigin",
                table: "Flights",
                column: "IdAirportOrigin");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_IdClient",
                table: "Flights",
                column: "IdClient");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_IdShip",
                table: "Flights",
                column: "IdShip");
